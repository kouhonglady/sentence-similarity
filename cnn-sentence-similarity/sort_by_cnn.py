...
tf.flags.DEFINE_string("test_new",r'E:\study\hrg_project\environment\dataset\precision_data\test.xls',"the path of the test file")
tf.flags.DEFINE_string("meta_graph_path", r'E:\study\hrg_project\bigDataCompetition\bank\sentence-similarity\cnn-sentence-similarity\runs\1539131966\checkpoints\model-22200.meta', "the path of the model witch has been trained")
tf.flags.DEFINE_string("latest_checkpoint", r"E:\study\hrg_project\bigDataCompetition\bank\sentence-similarity\cnn-sentence-similarity\runs\1539131966\checkpoints", "the path of the checkpoints files")
