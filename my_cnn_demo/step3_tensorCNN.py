# -*- coding: utf-8 -*-
"""
Created on Tue Jul 31 10:04:14 2018
...
## 输入层
#tf_X = tf.placeholder(tf.float32,[None,15,15,1])
## 输出层
...
#				
## 池化层
#max_pool1 = tf.nn.max_pool(relu_feature_maps1,ksize=[1,2,2,1],strides=[1,1,1,1],padding='SAME')
#
#print(max_pool1)
#
## 卷积层
...
#
## 将特征图进行展开
#max_pool2_flat = tf.reshape(max_pool2, [-1, 5*5*5])
#
## 全连接层
#fc_w1 = tf.Variable(tf.random_normal([5*5*5,50]))
